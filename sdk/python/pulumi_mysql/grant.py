...
class GrantArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[str]]] roles: A list of roles to grant to the user. Conflicts with `privileges`.
        ...
        if tls_option is not None:
            warnings.warn("""Please use tls_option in mysql_user.""", DeprecationWarning)
            pulumi.log.warn("""tls_option is deprecated: Please use tls_option in mysql_user.""")
        if tls_option is not None:
